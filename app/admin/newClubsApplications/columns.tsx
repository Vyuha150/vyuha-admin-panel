...
export const columns = (
  ...
  },
  {
    ...
    header: "Vision",
    cell: ({ row }) => (
      <div className="max-w-[300px] truncate" title={row.getValue("vision")}>
        {row.getValue("vision")}
      </div>
    ),
  },
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              className="cursor-pointer"
              disabled={!club.document}
              onClick={() => {
                if (club.document) {
                  window.open(
                    `${process.env.NEXT_PUBLIC_API_URL}/${club.document}`,
                    "_blank"
                  );
                }
              }}
